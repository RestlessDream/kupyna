...
const size_t dword_bsize = sizeof(dw);
const size_t rows_count = 8;
const size_t s_box_dimensions = S_BOX_DIMENSION;

kupyna_config kupyna_256 = { 64/byte_size, 512, 512/byte_size, 512/dword_size,
        256/byte_size, 10, 8};
kupyna_config kupyna_384 = { 64/byte_size, 1024, 1024/byte_size, 1024/dword_size,
        384/byte_size, 14, 16};
kupyna_config kupyna_512 = { 64/byte_size, 1024, 1024/byte_size, 1024/dword_size,
        512/byte_size, 14, 16};

kupyna_config * kupyna = &kupyna_256;

const byte s_box[S_BOX_DIMENSION][16][16] = {
    {
